...
type Gateway struct {
	...
	ConsoleAddress   *string                `protobuf:"bytes,21,opt,name=console_address,json=consoleAddress,proto3,oneof" json:"console_address,omitempty"`
...
const file_hypershell_v1_gateways_proto_rawDesc = "" +
	"\n" +
	"\x1chypershell/v1/gateways.proto\x12\rhypershell.v1\x1a\x1ahypershell/v1/common.proto\"\xc0\a\n" +
	"\aGateway\x12:\n" +
	...
	"\x11credential_driver\x18\x14 \x01(\tH\vR\x10credentialDriver\x88\x01\x01\x12,\n" +
	"\x0fconsole_address\x18\x15 \x01(\tH\fR\x0econsoleAddress\x88\x01\x01B\x0f\n" +
	"\r_external_dnsB\v\n" +
	"\t_tls_modeB\x0f\n" +
	"\r_service_typeB\t\n" +
	"\a_statusB\b\n" +
