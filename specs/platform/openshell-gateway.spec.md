...
| [`openshell-gateway-console.spec.md`](./openshell-gateway-console.spec.md) | Per-gateway Gateway Console (OpenShell dashboard) co-deployed with a confidential-client oauth2-proxy sidecar when routing is enabled |
